...
def find(i):
    ...
    while tag:
        try:
            ...
            "/html/body/form/div[5]/div/div[2]/div/div/div/div[1]/div/div/div[2]/input[1]").send_keys('xuej136')
            tag = False
        except:
            time.sleep(1)
    tag = True
    ...
    while tag:
        try:
            browser.find_element(by=By.XPATH, value=
            '/html/body/form/div[5]/div/div[2]/div/div/div/div[1]/div/div/div[2]/input[2]').send_keys('rA1W!7QZ')
            tag = False
        except:
            time.sleep(1)
    tag = True
